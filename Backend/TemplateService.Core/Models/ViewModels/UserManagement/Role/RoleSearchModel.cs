...
namespace TemplateService.Core.Models.ViewModels
{
    ...
    /// 
    /// </summary>
    [DebuggerDisplay("Pagination={Pagination}, Sorting={Sorting}, Name={Name}, Code={Code}, Date={Date}, IsActive={IsActive}, Description={Description}")]
    public class RoleSearchModel : BaseFilter
    {
        #region Constructors
        /// <summary>
